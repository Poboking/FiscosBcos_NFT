...
import org.sziit.infrastructure.dao.mapper.DictItemMapper;
import org.sziit.infrastructure.repository.DictItemRepository;
...
public class DictItemRepositoryImpl extends ServiceImpl<DictItemMapper, DictItemEntity>
     ...
     */
    @Override
    public List<DictItemEntity> getListByDictTypeCode(String dictTypeCode) {
        return dictItemMapper.selectList(new QueryWrapper<DictItemEntity>()
                .eq(Optional.ofNullable(dictTypeCode).isPresent(), "dict_type_id", dictTypeCode));
    }
}
